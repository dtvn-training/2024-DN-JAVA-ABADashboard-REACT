export const activeUserStats = {
  ...
  categories: ["Date the event occurred", "Day N", "Number of Active Users"],
};
...
export const eventStats = {
  ...
  categories: ["Date the event occurred", "Event Name", "Number of Events"],
};
...
export const countryStats = {
  ...
  categories: ["Date the event occurred", "Country", "Active Users"],
};
